...
class menu:
    ...
    def __init__(self):
        ...
        l2=Button(self.a,text='USER ACTIVITY',font='Papyrus 22 bold',fg='black',bg='yellow',width=19,padx=10,borderwidth=0,command=self.student).place(x=500,y=275)
        self.root.mainloop()
    ...
    def book(self):
        ...
        l5=Button(self.a,text='<- Main Menu',font='Papyrus 22 bold',fg='black',bg='yellow',width=15,padx=10,command=self.mainmenu).place(x=10,y=440)
    ...
    def student(self):
        ...
        l4=Button(self.a,text='Add User',font='Papyrus 22 bold',fg='black',bg='yellow',width=15,padx=10,command=self.activity).place(x=10,y=330)
        l4=Button(self.a,text='View Users',font='Papyrus 22 bold',fg='black',bg='yellow',width=15,padx=10,command=self.activity).place(x=10,y=430)
    ...
    def issue(self):
        ...
        e1=Entry(self.f1,width=25,bd=4,bg='orange',textvariable=self.aidd).place(x=230,y=100)
        l2=Label(self.f1,text='Student Id : ',font='papyrus 15 bold',bg='black',fg='orange').place(x=50,y=150)
        e2=Entry(self.f1,width=25,bd=4,bg='orange',textvariable=self.astudentt).place(x=230,y=150)
        l3=Label(self.f1,text='Student Name : ',font='papyrus 15 bold',bg='black',fg='orange').place(x=50,y=200)
        e3=Entry(self.f1,width=25,bd=4,bg='orange',textvariable=self.studentname).place(x=230,y=200)
        b1=Button(self.f1,text='Back',font='Papyrus 10 bold',fg='black',bg='orange',width=10,bd=3,command=self.rm).place(x=50,y=350)
        b1=Button(self.f1,text='Issue',font='Papyrus 10 bold',fg='black',bg='orange',width=10,bd=3,command=self.issuedbook).place(x=200,y=350)
                ...
                for i in an:
                    if i[1]>0:
                        try:
                            ...
                            values (?,?,?,date('now'),date('now','+14 day'))",(bookid.capitalize(),studentid.capitalize(),studentname.capitalize(),));
                            conn.commit()
    ...
    def activity(self):
        self.aidd=StringVar()
        self.astudentt=StringVar()
        self.f1=Frame(self.a,height=550,width=800,bg='black')
        self.f1.place(x=380,y=30)
    ...
    def searchact(self):
        self.list2=("BOOK ID","STUDENT ID","STUDENT NAME","ISSUE DATE","RETURN DATE")
        self.trees=self.create_tree(self.f1,self.list2)
        self.trees.place(x=50,y=150)
        conn=sqlite3.connect('test.db')
        bid=self.aidd.get()
